...
public class EMedicineHistoryTab  extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ehistorytab);
    	final Context context = getApplicationContext();
    	 session = new SessionManager(getApplicationContext()); 
         HashMap<String, String> user = session.getElderDetails();
       String  NRIC = user.get(SessionManager.KEY_ENRIC);
         String name = user.get(SessionManager.KEY_ENAME);
 ...
 DefaultHttpClient hc=new DefaultHttpClient();
	...
	if(d==0){
        ...
        adapter=new LazyAdapter6(this, songsList);
